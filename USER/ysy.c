...
void set_speed()
{
	    ...
	    Key_Temp=5;
			...
			{
				ClearScreen();
				ShowStr(0,1,"¹¥»÷ËÙ¶È"); ShowStr(0,60,"*");	ShowAI (0,66,attack_speed);
				delay_ms(50);
					...
					if(Key_Temp==4)
					{
						...
						while(1){
						ClearScreen();
						ShowStr(2,1,"Ñ²Ì¨ËÙ¶È"); ShowStr(0,60,"*");	ShowAI (2,66,normal_speed);
						delay_ms(50);
						...
						if(Key_Temp==4)             //speed++
						{
							while(1)
							{
								Key_Temp=5;
								ClearScreen();
								ShowStr(4,1,"ÉÏÌ¨ËÙ¶È"); ShowStr(0,60,"*");	ShowAI (4,66,-back_speed);
								delay_ms(50);
								Key = KEY_Scan(0);
								if(Key != 0) Key_Temp = Key;
								if(Key_Temp==2)             //speed--
